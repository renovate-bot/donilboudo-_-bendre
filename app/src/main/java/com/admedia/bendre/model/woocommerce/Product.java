...
public class Product implements Serializable {
    ...
    public Product(JsonObject object) {
        ...
        if (object.get("permalink") != null)
        {
            permalink = object.get("permalink").getAsString();
        }
        if (object.get("date_created") != null)
        {
            dateCreated = object.get("date_created").getAsString();
        }
        if (object.get("date_modified") != null)
        {
            dateModified = object.get("date_modified").getAsString();
        }
        ...
        if (object.get("featured") != null)
        {
            featured = object.get("featured").getAsBoolean();
        }
        if (object.get("catalog_visibility") != null)
        {
            catalogVisibility = object.get("catalog_visibility").getAsString();
        }
        if (object.get("description") != null)
        {
            description = object.get("description").getAsString();
        }
        if (object.get("short_description") != null)
        {
            shortDescription = object.get("short_description").getAsString();
        }
        if (object.get("regular_price") != null)
        {
            regularPrice = object.get("regular_price").getAsString();
        }
        if (object.get("images") != null)
        {
            JsonArray elements = object.get("images").getAsJsonArray();
            List<Image> images = new ArrayList<>();
            for (int counter = 0; counter < elements.size(); counter++)
            {
                JsonElement element = elements.get(counter);
                images.add(new Image((JsonObject) element));
            }
            setImages(images);
        }
    }
